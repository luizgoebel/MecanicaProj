...
namespace MecProj.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public FornecedorsController(MDRContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,CNPJ,Cidade,Bairro,Rua,Numero,Observacao,Data_Cadastro")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,CNPJ,Cidade,Bairro,Rua,Numero,Observacao,Data_Cadastro")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
